...
public class MainMenu
{
    ...
    private readonly DDDOrderingDemos _dddOrderingDemo;

    public MainMenu(InventoryDbContext context, OrderingDbContext orderingContext)
    {
        _db = context;
        ...
        _dddOrderingDemo = new DDDOrderingDemos(orderingContext, _db);
    }
